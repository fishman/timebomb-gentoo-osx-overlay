...
RDEPEND+="
	...
	app-arch/bzip2
	sys-libs/zlib
	|| ( >=media-video/ffmpeg-1.2 >=media-video/libav-9.8:= )
...
PATCHES=( "${FILESDIR}/${P}-compat.patch" ${FILESDIR}/${P}-osxopengl.patch)
...
src_prepare() {
	...
	#apply osx opengl patch
	#epatch "${FILESDIR}/${P}-osxopengl.patch"
}
